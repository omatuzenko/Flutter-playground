...
class _ExhibitionBottomSheetState extends State<ExhibitionBottomSheet>
  ...
  double get headerFontSize => lerp(14, 24) ?? 24;

  double get itemBorderRadius => lerp(8, 24) ?? 24;

  double get iconLeftBorderRadius => itemBorderRadius;

  double get iconRightBorderRadius => lerp(8, 0) ?? 0;

  double get iconSize => lerp(iconStartSize, iconEndSize) ?? iconEndSize;

  double iconTopMargin(int index) =>
      lerp(iconStartMarginTop,
          iconEndMarginTop + index * (iconsVerticalSpacing + iconEndSize)) ?? 0 +
      headerTopMargin!;
  ...
  Widget _buildIcon(Event event) {
    ...
    return Positioned(
      ...
      child: ClipRRect(
        ...
        child: Image.asset(
          'assets/images/projects/viewpagerparallax/${event.assetName}',
          fit: BoxFit.cover,
